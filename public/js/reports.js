...
async function getDailyReport(e) {
    try {
        ...
        let totalAmount = 0;
        const res = await axios.post("http://localhost:3000/user/dailyReports", { date: formattedDate }
        );
...
async function getMonthlyReport(e) {
    try {
        ...
        let totalAmount = 0;
        const res = await axios.post("http://localhost:3000/user/monthlyReports", { month: formattedMonth }
